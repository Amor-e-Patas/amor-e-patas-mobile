...
import { getAnimaisDesaparecidosReprovados, Animal } from "../../service/animal";
...
export default function MeusAnimaisDesaparecidosNaoAprovados() {
  ...
  useEffect(() => {
    async function fetchAPI() {
      try {
        const animais = await getAnimaisDesaparecidosReprovados();
        setAnimais(animais);
      } catch (err) {
        console.log(err);
      }
